...
- `src/clock_engine.py`: `evaluar_asistencia()` (tolerancias, cuota mensual, corte de ausencia) integrado en `MotorDeJornada.marcar_entrada()` y `registrar_asistencia(es_dia_lluvioso=...)`.
